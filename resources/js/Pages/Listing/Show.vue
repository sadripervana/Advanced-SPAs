    ...
    <div class="flex flex-col-reverse md:grid md:grid-cols-12 gap-4">
        ...
        <div class="md:col-span-5 flex flex-col gap-4">
            ...
            <Box>
                ...
                <div class="text-gray-200 dark:text-gray-400 text-lg font-bold mt-4">
                    <div class="text-gray-400 dark:text-gray-500">Monthly payment
                    </div>
                    <Price :price="monthlyPayment" class="text-white text-3xl font-bold" />
                </div>
